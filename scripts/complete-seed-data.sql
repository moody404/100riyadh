-- Complete Riyadh Restaurants Seed Data
-- This data is from comprehensive Google Maps and critical reviews analysis
-- Insert all restaurants with accurate information

-- Category 1: Saudi Cuisine (Most Popular)
...
-- Category 4: American Cuisine (Steakhouses & Burgers)
INSERT INTO restaurants (name, google_link, vote_count, created_by_device_id, status)
VALUES
...
-- Category 7: Lebanese & Middle Eastern Cuisine
INSERT INTO restaurants (name, google_link, vote_count, created_by_device_id, status)
VALUES
...
SELECT name, vote_count, status FROM restaurants ORDER BY vote_count DESC LIMIT 20;
